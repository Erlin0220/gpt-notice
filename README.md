...
列表第一项“新聊天”以新标签打开 ChatGPT 首页；其后默认展示前 8 个项目并提供“查看更多”，扩展 Popup 可把默认展示数量调整为 1–50。点击项目名称在当前标签进入项目主页；hover 后的 compose 图标以新标签打开同一项目主页，让 ChatGPT 自己在首条消息后创建 Conversation。
